...
class Settings(BaseSettings):
    ...
    # RAG chat (issue #11): embedding generation and the chat agent's final
    # answer both go through LiteLLM, gated by the same openrouter_api_key --
    # empty disables both (see extraction/embed.py's NullEmbeddingClient and
    # chat/model.py's NullChatModel).
